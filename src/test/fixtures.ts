...
export const sevdeskInvoices = {
  paid: {
    ...
    update: '2026-02-21T10:00:00Z', // Recently updated (paid)
    contact: {
      id: 'CONTACT-001',
      objectName: 'Contact',
    },
